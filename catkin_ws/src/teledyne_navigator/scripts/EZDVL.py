    ...
    while running:
        if (conn.in_waiting >= 88):
            ...
            if thisByte == chr(0x7D):
                ...
                Ensemble.bottom_translation.x = math.cos(mountingAngle) * x1 - math.sin(mountingAngle) * x3
                Ensemble.bottom_translation.y = x2
                Ensemble.bottom_translation.z = math.sin(mountingAngle) * x1 + math.cos(x3)
                ...
                Ensemble.reference_translation.x = math.cos(mountingAngle) * x1 - math.sin(mountingAngle) * x3
                Ensemble.reference_translation.y = x2
                Ensemble.reference_translation.z = math.sin(mountingAngle) * x1 + math.cos(x3)
